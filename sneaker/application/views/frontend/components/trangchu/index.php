    ...
    <div class="slider">
        <div class="container">
           <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 list-menu pull-left" style="height: 321px;">
             <img style="width: 100%; height: 160px;" src="public/images/benner-up.png">
             <img style="width: 100%; height: 160px;" src="public/images/benner-down.png">
         </div>
...
<div class="container" style="margin-top: 20px #008ee2;">
    <div class="sale-title">
        <span><img src="#" alt=""> KHUYẾN MÃI <img src="#" alt=""></span>
    </div>
</div>
<div class="container" style="margin-bottom: 20px;">
    <div class="owl-carousel owl-carousel-product owl-theme" style="border: 1px solid #999;">
        <?php 
...
<div class="container" style="margin-top: 20px color:#008ee2"">
    <div class="sale-title">
        <span><img src="#" alt=""> SẢN PHẨM BÁN CHẠY NHẤT <img src="#" alt=""></span>
    </div>
</div>
<div class="container" style="margin-bottom: 20px;">
    <div class="owl-carousel owl-carousel-product owl-theme" style="border: 1px solid #999;">
            ...
            if((count($listProducts) >= 3)):?>
                <div class="list-product">
                    <div class="list-header-z">
                        <h2><a href="<?php echo  $rowCategory['link']?>"> <img src="#" alt=""> <?php echo  $rowCategory['name']?> nổi bật <img src="#" alt=""></a></h2>
