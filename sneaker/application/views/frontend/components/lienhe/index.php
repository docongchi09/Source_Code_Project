...
<section>
	<div class="container">
		<div class="col-md-7 col-12">
			<div class="section-article contactpage" style="  padding-left: 20px;">
				...
				<form accept-charset="UTF-8" action="<?php echo base_url() ?>lien-he" id="contact" method="post">
					...
					<h1 style="color: #008ee2">Liên hệ với chúng tôi</h1>				
		...
		<div class="col-md-4 col-12">
			<div class="f-contact" style="padding-left: 35px;">
			<h1 style="color: #008ee2">Thông tin liên hệ</h1>
			<ul class="list-unstyled">
				<li class="clearfix">
					<i class="fa fa-map-marker fa-1x" style="color:#0f9ed8; padding: 20px; "></i>
					<span style="color: black"> Phường Đông Hòa, TP. Dĩ An, TP Hồ Chí Minh </span><br>
				</li>
				<li class="clearfix">
					<i class="fa fa-phone fa-1x" style="color:#0f9ed8;padding: 20px;  "></i>
					<span style="color: black">0359396991</span>
				</li>
				
				<li class="clearfix">
					<i class="fa fa-envelope fa-1x " style="color:#0f9ed8; padding: 20px; "></i>
					<span style="color: black"><a href="https://mail.google.com/mail/u/0/?tab=rm#inbox">docongchi@gmail.com</a></span>
				</li>
				<li class="clearfix">
					<i class="fa fa-comments" style="color:#0f9ed8; padding: 20px; " ></i>
					<span style="color: black"><a href="https://www.facebook.com/hachoahoaha">Fanpage</a></span>
				</li>
			</ul>
		</div>
	...
	<div class="col-md-12 col-lg-12 col-xs-12 col-12">
		...
		<div style="margin-top: 15px;">
			<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15672.924955851122!2d106.803054!3d10.870009!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xafa66f9c8be3c91!2zVHLGsOG7nW5nIMSQ4bqhaSBo4buNYyBDw7RuZyBuZ2jhu4cgVGjDtG5nIHRpbiAtIMSQSFFHIFRQLkhDTQ!5e0!3m2!1svi!2sus!4v1672898855468!5m2!1svi!2sus" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
