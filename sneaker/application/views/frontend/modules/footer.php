<footer id="footer">
        ...
        <div class="container">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <ul class="list-unstyled social pull-right">
                  <li><a href="https://www.facebook.com/hachoahoaha"><i class="fab fa-facebook-f"></i></a></li>
  ...
  <div class="top-footer">
    <div class="container">
        <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="col-xs-12 col-sm-6 ">
                <a href="trang-chu">
                    <img src="public/images/Messiesport.vn.png" style="width: 90%;" class="img-fix f-logo" alt="smart-construction">
                </a>
                <div class="about-store">
            MessiEsport - Giày chính hãng chất lượng cao 
             </div>
         </div>
         <div class="col-xs-12 col-sm-6">
            <div class="f-contact">
                ...
                <ul class="list-unstyled">
                    <li class="clearfix">
                        ...
                        <span>Phường Đông Hòa, TP Dĩ An, TP Bình Dương</span>
                    </li>
                    <li class="clearfix">
                        <i class="fa fa-phone"></i>
                        <span>0359396991</span>
                    </li>
                    
                    <li class="clearfix">
                        <i class="fa fa-envelope"></i>
                        <span><a href="mailto:docongchi@gmail.com">docongchi@gmail.com</a></span>
                    </li>
                    <li class="clearfix">
                        <i class="fa fa-comments"></i>
                        <span><a href="https://www.facebook.com/hachoahoaha">Fanpage</a></span>
                     </li>
                </ul>
            </div>
        </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-6">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6">
        <div class="col-xs-12 col-sm-6">
           <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3918.2312403776427!2d106.80086541473457!3d10.870008892258056!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x317527587e9ad5bf%3A0xafa66f9c8be3c91!2zVHLGsOG7nW5nIMSQ4bqhaSBo4buNYyBDw7RuZyBuZ2jhu4cgVGjDtG5nIHRpbiAtIMSQSFFHIFRQLkhDTQ!5e0!3m2!1svi!2s!4v1672848451481!5m2!1svi!2s" width="423" height="157" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
        </div>
        ...
        <div class="contact-title">
          <div class="contact-text-wrapper">
            ...
            <div class="text-center">
              <div><a href="tel:0928.167.489" rel="nofollow">0928.167.489 <b>(Do Cong Chi)</b></a></div>
              <div><span>Email: docongchi@gmail.com</span></div>
            </div>
          </div>
        </div>
        <div class="contact-set flex text-center"><!--===* Tạo gạch ngăn class="contact-set flex text-center"===-->
          <div class="w-50">
            <a href="http://zalo.me/0359396991" rel="noopener nofollow" target="_blank" title="Chat Zalo">
              <div class="flex-center"><span class="flex has-icon zalo-icon"></span></div>
              <div>
                <h4>Chat Zalo</h4>
                <p>Chat trực tuyến với nhân viên MessiEsport </p>
              </div>
            </a>
          </div>
          <div></div>
          <!--=== bỏ ở đây ===--><div class="w-50">
            <a href="https://www.facebook.com/hachoahoaha" title="Liên hệ Fanpage">
              <div class="flex-center"><img src="https://img.icons8.com/fluency/48/000000/facebook-new.png"/></div>
              <div>
                <h4>Gửi yêu cầu hỗ trợ</h4>
                <p>MessiEsport sẽ phản hồi ngay !</p>
              </div>
            </a>
          </div><!--=== bỏ ở đây ===-->
        </div>
